                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 ml-auto">
                            ...
                            >
                              ...
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="stroke-[2] size-3 sm:size-4 text-secondary transition-transform false"><path d="M6 9L12 15L18 9" stroke="currentColor" strokeLinecap="square"></path></svg>
                            </button>
                            <button
                              type="submit"
                              disabled={!input.trim() || isPending}
